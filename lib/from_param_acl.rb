...
module FromParamAcl
  ...
  module ActiveRecordExtensions
    ...
    module ClassMethods
      ...
      def is_readable_by?(agent, current_context = nil)
        true
      end
      
      # Override in model to define permissions for new object creation.
      # Defaults to true, providing access to any user.
      def is_creatable_by?(agent, current_context = nil)
        true
      end
